...
<body id="container-page-configAdmin">
    ...
    <section id="prove-product-cat-config">
        <div class="container">
          ...
          <li>
            ...
            <li>
              <a href="configAdmin.php?view=bank">
                <i class="fa fa-university" aria-hidden="true"></i> &nbsp; Pagos
              </a>
            </li>
            <li>
          ...
          <?php
            $content=$_GET['view'];
            $WhiteList=["product","productlist","productinfo","provider","providerlist","providerinfo","category","categorylist","categoryinfo","admin","adminlist","order","bank","account","cliente","clientelist","clienteinfo"];
            if(isset($content)){
