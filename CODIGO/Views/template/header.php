...
<head>
    ...
    <title>El Palacio de las Cunas</title>
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner.jpg">
                            <div class="hero__text">
                                <span>MUEBLES Y MUCHO MÁS PARA TU BEBÉ</span>
                                <h2>HECHOS A TU GUSTO <br />Y CON MUCHO AMOR</h2>
                                <p>Entrega gratuitas disponibles</p>
