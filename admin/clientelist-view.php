<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=clientelist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Clientes de la tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
                      	...
                      	<tbody>
							...
							<tr>
								...
								<td class="text-center">
	                        		<a href="configAdmin.php?view=clienteinfo&code=<?php echo $prov['NIT']; ?>" class="btn btn-raised btn-xs btn-success">Actualizar</a>
	                        	</td>
	                        	<td class="text-center">
	                        		<form action="process/delcliente.php" method="POST" class="FormCatElec" data-form="delete">
	                        			<input type="hidden" name="nit-cliente" value="<?php echo $prov['NIT']; ?>">
                  ...
                  <ul class="pagination">
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="configAdmin.php?view=clientelist&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="configAdmin.php?view=clientelist&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
                    ...
                    <?php else: ?>
                        <li>
                            <a href="configAdmin.php?view=clientelist&pag=<?php echo $pagina+1; ?>">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
