    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <?php
                    $code=$_GET['code'];
                    $proveedor=ejecutarSQL::consultar("SELECT * FROM cliente WHERE NIT='$code'");
                ...
                <form action="process/updatecliente.php" method="POST" class="FormCatElec" data-form="update">
                    <input type="hidden" name="nit-prove-old" value="<?php echo $prov['NIT']; ?>">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label">NIT/CEDULA</label>
                                    <input class="form-control" value="<?php echo $prov['NIT']; ?>" type="text" name="prove-nit" readonly pattern="[0-9]{1,20}" maxlength="20" required="">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Nombre</label>
                                    <input class="form-control" type="text" value="<?php echo $prov['Nombre']; ?>" name="prove-name" maxlength="30" required="">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" value="<?php echo $prov['Email']; ?>" type="email" name="prove-web">
                                </div>
                            </div>
                        </div>
                    </div>
