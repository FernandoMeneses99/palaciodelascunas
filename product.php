       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">MAXICOMPRAS</small></h1>
            </div>
            <?php
            ...
            <?php
                ...
                $consultaSQL = "SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE Stock > 0 AND Estado='Activo'";

                if($categoria != ""){
                    $consultaSQL .= " AND CodigoCat='$categoria'";
                }
                ...
                $consultaSQL .= " LIMIT $inicio, $regpagina";

                $mysqli = mysqli_connect(SERVER, USER, PASS, BD);
                mysqli_set_charset($mysqli, "utf8");

                $consultar_productos = mysqli_query($mysqli, $consultaSQL);
                ...
                if(mysqli_num_rows($consultar_productos) >= 1){
                  if($categoria != ""){
                      ...
                      echo '<h3 class="text-center">Se muestran todos los productos disponibles</h3><br>';
                  }
